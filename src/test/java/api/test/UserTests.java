...
public class UserTests {
	...
	public void testPostUser(){
		...
		Response res1=UserEndPoints.createUser(userpayload);
		res1.then().log().all();
	...
	public void testGetUser() {
		...
		Response res2=UserEndPoints.getUser(this.userpayload.getUsername());
		res2.then().log().all();
	...
	public void testUpdateUser(){
		...
		Response res1=UserEndPoints.updateUser(this.userpayload.getUsername(), userpayload);
		res1.then().log().all();
	...
	public void testDeleteUser() {
		...
		Response res2=UserEndPoints.deleteUser(this.userpayload.getUsername());
		res2.then().log().all();
		Assert.assertEquals(res2.statusCode(),200);
